...
export default function Contact() {
  ...
  return (
    <section id="contact" className="contact section-container">
      <div className="contact__card glass-card reveal" ref={ref} style={{ position: 'relative', overflow: 'hidden' }}>
        <div className="contact__info" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <form className="contact__form" onSubmit={handleSubmit} noValidate style={{ position: 'relative', zIndex: 10 }}>
